...
//                            JSONObject json = new JSONObject().getJSONObject(response);
//                            resultBean.setId(json.getString("id"));
//                            resultBean.setHitokoto(json.getString("hitokoto"));
//                            resultBean.setFrom(json.getString("from"));
//                            resultBean.setType(json.getString("type"));
//
//                            MissView.updateAppWidget(YiYanService.this, AppWidgetManager.getInstance(YiYanService.this), i,resultBean);
                        }catch (Exception e){
